...
from .a_stock import (
    ...
    get_margin_balance as get_astock_margin_balance,
    get_shibor as get_astock_shibor,
    get_guba_sentiment as get_astock_guba_sentiment,
    get_xueqiu_discussions as get_astock_xueqiu_discussions,
)
...
VENDOR_METHODS = {
    ...
    # signal_data — new
    "get_margin_balance": {
        "a_stock": get_astock_margin_balance,
    },
    "get_shibor": {
        "a_stock": get_astock_shibor,
    },
    # news_data — new
    "get_guba_sentiment": {
        "a_stock": get_astock_guba_sentiment,
    },
    "get_xueqiu_discussions": {
        "a_stock": get_astock_xueqiu_discussions,
    },
}

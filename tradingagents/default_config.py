...
DEFAULT_CONFIG = {
    ...
    # Token limits for LLM output.
    # Reasoning models (deepseek-v4-pro) burn tokens internally —
    # only ~30% of budget reaches user-visible output. 260K → ~80K visible.
    "max_tokens": 262144,             # 256K total budget
    ...
    "data_vendors": {
        ...
        "margin_data": "a_stock",            # Margin balance (两融余额)
        "sentiment_data": "a_stock",         # Sentiment data (guba, xueqiu discussions)
    },

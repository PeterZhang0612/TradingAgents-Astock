...
_PROVIDER_CONFIG = {
    ...
    # openai_compatible: no default URL or key — all from base_url / custom env vars
    "openai_compatible": (None, None),
}


class OpenAIClient(BaseLLMClient):
    """Client for OpenAI, Ollama, OpenRouter, xAI, and custom compatible providers.
    ...
    def get_llm(self) -> Any:
        ...
        if self.provider in _PROVIDER_CONFIG:
            ...
            if api_key_env:
                ...
                llm_kwargs["api_key"] = "ollama"  # dummy — Ollama doesn't validate
            # openai_compatible: no default api_key, let ChatOpenAI fall back
            # to OPENAI_API_KEY env var or user-provided api_key in config
        elif self.base_url:

...
- Northbound Retreat: {northbound_flow} — Net outflow from Stock Connect signals foreign institutions reducing exposure
...
Trading framework / discipline report (A股交易纪律): {trading_framework_report}

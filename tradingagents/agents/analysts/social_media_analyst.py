...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            "\n- `smart_search_cli(query)`：**主力情绪工具**——搜索股吧散户、雪球专业投资者、X/Twitter 全球、微博热搜"
            "\n\n分析步骤（smart_search 每次 60-120s，合并查询减少等待）："
            "\n1. 用 smart_search_cli 搜索 '<股票名> 股吧 散户 雪球 投资者 X Twitter 讨论 情绪 新闻 舆论 2026年6月'"
            "\n2. 调用 get_news 获取公司新闻，验证情绪一致性"
            ...
            "\n2. X/Twitter 全球投资者观点 + 新闻舆论方向（用 smart_search_cli 合并搜索）"
            "\n3. 新闻检索条数和时间范围"
            "\n4. 正面/负面/中性新闻比例"
            "\n5. 排名前 3 的舆情主题"

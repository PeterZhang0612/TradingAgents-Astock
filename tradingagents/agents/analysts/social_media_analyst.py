...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            "\n- **情绪量化**：使用 `smart_search_cli` 搜索股吧和雪球的真实讨论数据，引用搜索结果而非靠 LLM 知识推测。"
            ...
            "\n- `smart_search_cli(query)`：**主力情绪工具**——搜索股吧散户情绪、雪球投资者讨论、X/Twitter 全球观点"
            "\n\n分析步骤："
            "\n1. 用 smart_search_cli 搜索 '<股票名> 股吧 散户 情绪 2026年6月'"
            "\n2. 用 smart_search_cli 搜索 '<股票名> 雪球 投资者 讨论 2026年6月'"
            ...
            "\n1. 东方财富股吧看涨/看跌情绪比例（用 smart_search_cli 搜索）"
            "\n2. 雪球讨论热度和主要观点（用 smart_search_cli 搜索）"
            "\n3. 新闻检索条数和时间范围"
            "\n4. 正面/负面/中性新闻比例"
            "\n5. 排名前 3 的舆情主题"

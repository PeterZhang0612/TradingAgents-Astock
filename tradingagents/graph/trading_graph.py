...
class TradingAgentsGraph:
    ...
    def __init__(
        self,
        selected_analysts=["market", "social", "news", "fundamentals", "policy", "hot_money", "lockup", "trading_framework"],
        debug=False,
    ...
    def _get_provider_kwargs(self) -> Dict[str, Any]:
        ...
        # Forward API key if provided in config
        if self.config.get("api_key"):
            kwargs["api_key"] = self.config["api_key"]

        # Forward max_tokens if set (default 65536 for large-context models)
    ...
    def _log_state(self, trade_date, final_state):
        ...
        self.log_states_dict[str(trade_date)] = {
            ...
            "trading_framework_report": final_state.get("trading_framework_report", ""),

...
class GraphSetup:
    ...
    def setup_graph(
        self, selected_analysts=["market", "social", "news", "fundamentals", "policy", "hot_money", "lockup", "trading_framework"]
    ):
        ...
        Args:
            selected_analysts (list): List of analyst types to include. Options are:
                ...
                - "trading_framework": Trading framework analyst (A股交易纪律/概率化/风险前置)
        """
        ...
        if "trading_framework" in selected_analysts:
            analyst_nodes["trading_framework"] = create_trading_framework_analyst(
                self.quick_thinking_llm
            )
            delete_nodes["trading_framework"] = create_msg_delete()
            tool_nodes["trading_framework"] = self.tool_nodes["trading_framework"]
        ...
        # Sequential chain (parallelism at the runner layer via ThreadPool)

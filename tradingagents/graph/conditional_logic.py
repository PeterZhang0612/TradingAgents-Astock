...
class ConditionalLogic:
    ...
    def should_continue_trading_framework(self, state: AgentState):
        """Determine if trading framework analysis should continue."""
        messages = state["messages"]
        last_message = messages[-1]
        if last_message.tool_calls:
            return "tools_trading_framework"
        return "Msg Clear Trading_framework"

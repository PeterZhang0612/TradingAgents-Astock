...
def save_report_to_disk(final_state, ticker: str, save_path: Path):
    ...
    if final_state.get("trading_framework_report"):
        analysts_dir.mkdir(exist_ok=True)
        (analysts_dir / "trading_framework.md").write_text(final_state["trading_framework_report"], encoding="utf-8")
        analyst_parts.append(("Trading Framework Analyst", final_state["trading_framework_report"]))
    if analyst_parts:
...
ANALYST_ORDER = ["market", "social", "news", "fundamentals", "policy", "hot_money", "lockup", "trading_framework"]
ANALYST_AGENT_NAMES = {
    "market": "Market Analyst",
    "social": "Social Analyst",
    "news": "News Analyst",
    ...
    "hot_money": "Hot Money Analyst",
    "lockup": "Lockup Analyst",
    "trading_framework": "Trading Framework Analyst",
}
ANALYST_REPORT_MAP = {
    ...
    "trading_framework": "trading_framework_report",
}
